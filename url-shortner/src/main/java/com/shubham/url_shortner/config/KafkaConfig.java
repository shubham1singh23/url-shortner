package com.shubham.url_shortner.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ClickEvent> consumerFactory() {
        ...
        JsonDeserializer<ClickEvent> jsonDeserializer =
                new JsonDeserializer<>(ClickEvent.class);

        jsonDeserializer.addTrustedPackages(
                "com.shubham.url_shortner"
        );
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ClickEvent>
